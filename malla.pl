...
% salida: retorna verdadero si "Asignatura" no esta en "Aprobados" y
% todos sus prerrequisitos si lo estan
% entrada: Asignatura: asignatura no aprobada que se quiere ver.
% Aprobados: asignatura/s que se ingresan como aprobadas.
...
% salida: verdadero si "Pre" es prerrequisito directo o indirecto de
% asignatura (cierre transitivo)
% entrada: Pre: asignatura que se asume como prerrequisito de una.
% Asignatura: asignatura de la cual se vera si Pre es prerresito.
...
% firma: permite_dar(+AprobadosPrev, +AsignaturaRecienAprobada,
% -NuevosHabilitados)
% salida: "NuevosHabilitados" es la lista (sin duplicados) de
% asignaturas que pasan a quedar habilitados al agregar
% "AsignaturaRecienAprobada" al conjuntos "AprobadosPrev", y que no
% estaban habilitados antes.
% entrada: AprobadosPrev: asignaturas que ya estaban aprobadas.
% AsignaturaRecienAprobada: asignatura que se acaba de aprobar.
% NuevosHabilitados: asignaturas "desbloqueadas" por aprobar el nuevo
% ramo.
...
% firma: siguiente_semestre(+Aprobados, +SemActual, +MaxCredSem,
% -AsignaturasSugeridas)
% salida: AsignaturasSugeridas es la lista optima para el siguiente
% semestre bajo tope "MaxCredSem". la seleccion siempre prioriza (1)
% asignaturas de semestres mas antiguos pendientes (1,2,...,SemActual),
% luego los del mismo semestre y, solo si queda cupo, continua con
% semestres posteriores.
% entrada: Aprobados: asignaturas aprobadas por el momento. SemActual:
% semestre actual en el que se encuentra. MaxCredSem: maximo de creditos
% para el semestre. AsignaturasSugeridas: lista de las asignaturas
% sugeridas.
...
% firma: prioridad_para(+SemActual, +Codigo, -Clave)
% salida: clave es un numero que representa la prioridad con la que se
% debe ordenar una asignatura. primero van las pendientes de semestres
% anteriores, luego las del mismo semestre, y al final las posteriores
% entrada: SemActual: semestre actual en el que se encuentra. Codigo:
% codigo de la asignatura. Clave: prioridad de la asignatura.
prioridad_para(SemActual, Codigo, Clave) :-
    asignatura(Codigo,_,_,Sem,Orden),
...
% salida: Plan es la secuencia optima de semestres para completar toda
% la malla curricular, partiendo en "SemActual", bajo un tope de
% creditos "MaxCredSem" por semestre.
% entrada: Aprobados: asignaturas aprobadas por el momento. SemActual:
% semestre en el que se encuentra actualmente. MaxCredSem: maximo de
% creditos por semestre. Plan: listado de las asignaturas a tomar en
% cada semestre de manera optima.
